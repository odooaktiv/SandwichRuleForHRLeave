        ...
        if self.employee_id:
            ...
            if self.date_from:
                ...
                if date_number not in days:
                    res.update({'value': {'date_to': '','date_from': '','number_of_days_temp':0.00,'sandwich_rule':False}, 'warning': {
            ...
            if self.date_to:
                ...
                if date_number not in days:
                    res.update({'value': {'date_to': '','number_of_days_temp':0.00,'sandwich_rule':False}, 'warning': {
                               'title': 'Validation!', 'message': 'This day is already holiday.'}})
